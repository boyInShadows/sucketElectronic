...
const CardProductComponent = ({ product }) => {
  ...
  return (
    <div
      className="group bg-white rounded-2xl border border-neutral-200 hover:shadow-xl shadow-md transition-all duration-300 overflow-hidden p-0 flex flex-col items-stretch relative"
      dir="rtl"
    >
      <span className="absolute top-4 left-4 bg-primary/90 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md z-10">
        جدید
      </span>
